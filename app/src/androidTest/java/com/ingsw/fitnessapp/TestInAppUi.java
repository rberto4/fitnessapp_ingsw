...
public class TestInAppUi {
    ...
    public void apriSchermataNuovoEsercizio(){
        ...
        intended(hasComponent(NuovoEsercizioActivity.class.getName()));// verifico l'intent tramite il nome della classe
        Intents.release(); // rilascio "l'ascolto" dell'intent
    }
